  ...
  return (
    <>
      ...
      <section className="project project--details project--left">
        ...
        <p>Xin chào , chúc mừng sinh nhật khách hàng , trước khi khách hàng tiến tới các dịch vụ tiếp theo thì xin phép cho tui nói đôi lời đã =))), đáng lẽ ăn trộm nhiều ảnh thế này phải xin phép trước , nhưng mà để giữ tính bí mật và món quà này là độc quyền của bạn nào đấy thế nên là tui xin phép nhen, hehe</p>
      </section></>
  )
}
